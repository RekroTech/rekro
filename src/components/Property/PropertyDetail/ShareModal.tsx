...
import { useCreatePropertyShare } from "@/lib/react-query/hooks/usePropertyShare";
...
export function ShareModal({
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title={`Share ${propertyTitle}`}>
            <div className="space-y-4">
                ...
                {activeTab === "social" && (
                    <div className="space-y-3">
                        <p className="text-sm text-text-muted">
                            Share this property on your favorite social media platform
                        </p>
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <button
                                ...
                                className="flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium text-white bg-sky-500 rounded-lg hover:bg-sky-600 transition-colors"
                            >
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <button
                                ...
                                className="flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium text-white bg-green-500 rounded-lg hover:bg-green-600 transition-colors"
                            >
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <button
                                ...
                                className="flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 transition-colors"
                            >
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
