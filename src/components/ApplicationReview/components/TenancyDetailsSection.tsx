...
import { formatDateLocale, formatRentalDuration } from "@/lib/utils/dateUtils";
...
export const TenancyDetailsSection = React.memo(({
    ...
    const formattedMoveInDate = formatDateLocale(application?.move_in_date);

    const formattedRentalDuration = formatRentalDuration(application?.rental_duration);
